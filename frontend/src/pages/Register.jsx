  ...
  return (
    <div className="mt-2">
      <div className="flex justify-between items-center mb-1">
        ...
        <span className={`text-xs font-medium ${password ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="form-group">
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-xl border ${errors.firstName ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200'} bg-white/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all`}
                  placeholder="John"
                />
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-xl border ${errors.lastName ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200'} bg-white/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all`}
                  placeholder="Doe"
                />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="form-group">
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-xl border ${errors.companyName ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200'} bg-white/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all`}
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-xl border ${errors.phone ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200'} bg-white/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all`}
            ...
            <div className="form-group relative">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-xl border ${errors.confirmPassword ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200'} bg-white/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all pr-10`}
